...
# lmm_target_words_skip <- glmer(skip_first_pass ~ Freq * Tracker + (Tracker  | sub) + (Freq | item),
#                              data = target_words_exp1, family = binomial)
# 
# summary(lmm_target_words_skip)
...
qs_save(blmm_target_skip_exp1, "LAB/models/brms/blmm_target_skip_exp1.qs")
