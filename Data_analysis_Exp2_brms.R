...
# write corpus_words_exp2$wordID into a text file, one line per word, no punctuation, same order as in the data frame

# remove punctuation and all lower case
words_for_espal <- gsub("[[:punct:]]", "", corpus_words_exp2$wordID) %>% tolower() %>% unique()
...
contrasts(target_words_exp2$Tracker) <- c(0.5,-.5) #contr.sum(2)

contrasts(corpus_words_exp2$Tracker) <- c(0.5,-.5) #contr.sum(2)
...
exp2_word_frequency_data <- read_tsv("LAB-SPAIN/spanish_corpus_words_with_frequencies_espal.txt") %>% select(word,frq,zipf,num_letters)
...
qs_save(blmm_corpus_FFD_exp2_exgaussian, "LAB-SPAIN/models/brms/blmm_corpus_FFD_exp2_exgaussian.qs")
...
qs_save(blmm_corpus_GD_exp2_exgaussian, "LAB-SPAIN/models/brms/blmm_corpus_GD_exp2_exgaussian.qs")
...
qs_save(blmm_corpus_SFD_exp2_exgaussian, "LAB-SPAIN/models/brms/blmm_corpus_SFD_exp2_exgaussian.qs")
...
qs_save(blmm_corpus_TVT_exp2_exgaussian, "LAB-SPAIN/models/brms/blmm_corpus_TVT_exp2_exgaussian.qs")
...
qs_save(blmm_corpus_FFD_exp2_exgaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_FFD_exp2_exgaussian_len.qs")
# gaussian
...
qs_save(blmm_corpus_FFD_exp2_gaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_FFD_exp2_gaussian_len.qs")
...
qs_save(blmm_corpus_GD_exp2_exgaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_GD_exp2_exgaussian_len.qs")
...
qs_save(blmm_corpus_GD_exp2_gaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_GD_exp2_gaussian_len.qs")
# SFD, with len
...
qs_save(blmm_corpus_SFD_exp2_exgaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_SFD_exp2_exgaussian_len.qs")
# gaussian
...
qs_save(blmm_corpus_SFD_exp2_gaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_SFD_exp2_gaussian_len.qs")
...
qs_save(blmm_corpus_TVT_exp2_exgaussian_len, "LAB-SPAIN/models/brms/blmm_corpus_TVT_exp2_exgaussian_len.qs")
#gaussian
